...
describe "Installer", "operations" do
  ...
  it "훅을 설치할 경로와 발동 조건 정보를 파일에서 읽어올 수 있다" do
    @installer.prepare_paths_to_install('./installer/spec/data/install_list').should == [['/tmp/test_install_git_hook', @trigger_point], ['/tmp/test_install_git_hook2', @trigger_point]]
  end
